...
export default function PreviousGame({ game }) {
  ...
  const winnerName = game.winner_display_name || game.winner_email?.split('@')[0] || 'Winner'
    ...
    >
      <div className="flex items-center gap-2 mb-4">
        ...
        <span className="text-sm font-semibold" style={{ color: 'var(--text-muted)' }}>
          Previous Round #{game.round_id || game.id}
        </span>
      ...
      {winnerName && (
        ...
        >
          <div
            ...
            style={{ background: avatarColor(winnerName) }}
          >
